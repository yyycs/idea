	...
	//here starts ogario
	 (function (more2ogarset, more1ogarset, moreogarset) {
		var more3ogarset = null,
			...
			ogarbuffed = {
				'pl': {
					...
					//Golman Key
					'hk-dstbot': `Bots Destination`,
					'hk-botfeed': `Bots Feed`,
					'hk-botsplit': `Bots Split`,
					'hk-botsplitX2': `Bots SplitX2`,
					'hk-botsplitX4': `Bots SplitX4`,					
					'hk-botvshield': `Bots VShield`,
					'hk-botsmode': `Bots Mode`,
					//End					
					...
					'pause': 'PAUZA!',
					'visit': `Odwiedź`,
					'exit': 'Agarbot.OVH: Czy na pewno chcesz opuścic grę?',
				...
				'en': {
					...
					'pause': 'PAUSE!',
					'visit': `Visit`,
					'exit': `Agarbot.OVH: Are you sure you want to quit the game?`,
		...
		var ogarminimapdrawer = {
			...
			'feedInterval': null,
			//GOlman
			'botfeedInterval': null,
			'botsplitInterval': null,
			//End
			'getPlayerX': function () {
			...
			//Golman
			'botfeed': function (ogarsettings) {
				if (ogarsettings) {
					if (this[`botfeedInterval`]) return;
					var more2ogarset = this;
					if(window.xt)window.client.send(JSON.stringify({action:15}));
					this[`botfeedInterval`] = setInterval(function () {
						if(window.xt)window.client.send(JSON.stringify({action:15}));
					}, 25);
				} else this[`botfeedInterval`] && (clearInterval(this[`botfeedInterval`]), this[`botfeedInterval`] = null);
			},
			'botsplit': function () {
				// more2ogarset[`core`] && more2ogarset[`core`][`split`] && more2ogarset[`core`]['split']();
				if(window.xt)window.client.send(JSON.stringify({action:16}));
				/*if (ogarsettings) {
					if (this[`botsplitInterval`]) return;
					var more2ogarset = this;
					if(window.xt)window.client.send(JSON.stringify({action:16}));
					this[`botsplitInterval`] = setInterval(function () {
						if(window.xt)window.client.send(JSON.stringify({action:16}));
					}, 80);
				} else this[`botsplitInterval`] && (clearInterval(this[`botsplitInterval`]), this[`botsplitInterval`] = null);*/
			},
			'botsplitX2': function (ogarsettings) {
				var ogarsettings = this;
				if(window.xt)window.client.send(JSON.stringify({action:16}));
				setTimeout(function () {
					if(window.xt)window.client.send(JSON.stringify({action:16}));
			...
			'botsplitX4': function (ogarsettings) {
				var ogarsettings = this;
				if(window.xt)window.client.send(JSON.stringify({action:16}));
				setTimeout(function () {
					if(window.xt)window.client.send(JSON.stringify({action:16}));
			...
			//Golman
			'setDstBot': function () {
				 if (window.botmode3Change == true && window.xt)
				 {
						if (window.botmode3 == 0)
						{
							console.log('Here:'+window.botmode3);
							window.botmode3 = 1;
							$('#destination').html('<p id="destination">Destination : CELL</p>');
						}
						else if (window.botmode3 == 1)
						{
							console.log('Here:'+window.botmode3);
							window.botmode3 = 0;
			...
			'setbotvshield': function () {
				 if (window.botmode2Change == true && window.xt)
				 {
						if (window.botmode2 == 0)
						{
							window.botmode2 = 1;
							window.client.botmode2(1);
							$('#botmode2').html('<p id="botmode2">vShield : On</p>');
						}
						else if (window.botmode2 == 1)
						{
							window.botmode2 = 0;
							window.client.botmode2(0);
							$('#botmode2').html('<p id="botmode2">vShield : Off</p>');
						}
				 }
			},
			'setbotsmode': function () {
				 if (window.xt)
				 {
	                	window.client.send(JSON.stringify({
	                		action:21
	                	}));
						refresh();
				 }
			...
			'setNormalLb': function () {
				ogario1Settings[`normalLb`] ? moreogarset(`#leaderboard-hud h4`)[`html`](ogarcomms[`leaderboard`]) : moreogarset(`#leaderboard-hud h4`)[`html`](`agarbot.ovh`);
			},
			...
			'connect': function () {
				this[`closeConnection`](), this[`flushData`](), this[`setParty`](), console[`log`](`[Ogario V4] Connecting to server`), this['privateMode'] && this[`privateIP`] ? this[`socket`] = new WebSocket(this[`privateIP`]) : this[`socket`] = new WebSocket(this[`publicIP`]), this[`socket`][`ogarioWS`] = !0, this[`socket`][`binaryType`] = `arraybuffer`;
				var ogarsettings = this;
				this[`socket`][`onopen`] = function () {
					console['log']('[Ogario V4] Socket open');
					...
					ogarsettings[`flushData`](), console[`log`](`[Agarbot.OVH] Socket close`, more2ogarset);
				}, this[`socket`][`onerror`] = function (more2ogarset) {
					ogarsettings[`flushData`](), console[`log`](`[Agarbot.OVH] Socket error`, more2ogarset);
				};
			},
		...
		var doagarcommand = {
			...
			'connect': function (ogarsettings) {
				//GOlman
				if (window.client.currentServer != ogarsettings)window.sliderValue = undefined;
				// window.sliderValue = undefined;
				window.client.currentServer = ogarsettings;
				window.isAlive = false;
				if($('#botslaunch').length != 0) {
						window.firstconnect = false;
						 document.getElementById('botslaunch').innerHTML = '';
				}
				//GolmanEnd
				console['log'](`[Agar.IO] Connecting to game server:`, ogarsettings);
				var more1ogarset = this;
			...
			'onOpen': function (ogarsettings) {
				...
				more2ogarset[`setUint8`](0, 254), more2ogarset['setUint32'](1, 22, !0), this[`sendMessage`](more2ogarset), (more2ogarset = this['createView'](5))[`setUint8`](0, 255), more2ogarset[`setUint32`](1, this[`clientVersion`], !0), this[`sendMessage`](more2ogarset), this[`connectionOpened`] = !0;
			},
			...
			'onError': function (ogarsettings) {
				console[`log`](`[Agarbot.OVH] Game server socket error`), this[`flushCellsData`](), more2ogarset[`master`] && more2ogarset[`master`][`onDisconnect`] && more2ogarset[`master`][`onDisconnect`]();
			},
			'onClose': function (ogarsettings) {
				console['log'](`[Agarbot.OVH] Game server socket close`), this[`flushCellsData`](), more2ogarset[`master`] && more2ogarset[`master`][`onDisconnect`] && more2ogarset[`master`]['onDisconnect']();
			},
			'closeConnection': function () {
				if (this[`socket`]) {
			...
			'sendNick': function (name) {
				...
				grecaptcha.ready(function() {
					grecaptcha.execute('6LcEt74UAAAAAIc_T6dWpsRufGCvvau5Fd7_G1tY', {action: 'play'}).then(function(token) {
						...
						if (window.xt)
						  {
							...
							if (!window.firstconnect) {
							  ...
							  window.botmode2Change = true;
							  window.botmode3Change = true;
						...
						name = more2ogarset[`unescape`](more2ogarset[`encodeURIComponent`](name));
						var buf = that.createView(3 + name.length + token.length);
						buf.setUint8(0, 0);
						for (var i = 0; i < name.length; i++) buf.setUint8(i + 1, name.charCodeAt(i));
						buf.setUint8(name.length + 1, 0);
						for (var i = 0; i < token.length; i++) buf.setUint8(name.length + 2 + i, token.charCodeAt(i));
						buf.setUint8(name.length + 1 + token.length + 1 , 0);
						that.sendMessage(buf);
					});
				});
			},
				...
				if (this[`isSocketOpen`]() && this[`connectionOpened`] && this[`clientKey`]) {
					var ogarsettings = this[`cursorX`],
						...
						if (window.iamleader){
							var e = {};
							e.action = 14;
							e.a = this[`playerX`] + this.mapOffsetX;
							e.b = this[`playerY`] + this.mapOffsetY;
							if(window.xt) window.client._ws.send(JSON.stringify(e));
						}
						if (window.botmode3 == 0)
						{
							// console.log(this[`cursorX`] + this.mapOffsetX,this[`cursorY`] + this.mapOffsetY);
							if (window.xt)window.client.sendMove(this[`cursorX`] + this.mapOffsetX,this[`cursorY`] + this.mapOffsetY);
						}
						else
						{
							// console.log(this[`playerX`] + this.mapOffsetX,this[`playerY`] + this.mapOffsetY);
							if (window.xt)window.client.sendMove(this[`playerX`] + this.mapOffsetX,this[`playerY`] + this.mapOffsetY);
						}
						//End	
            ...
            "sendAccessToken": function(shapes, options, oW) {
                ...
                doagarcommand.writeUint32(data, curr + count + 23);
                data.push(8, 10, 82);
                doagarcommand.writeUint32(data, curr + count + 18);
                ...
                doagarcommand.writeUint32(data, curr + 3);
                //this.writeUint32(data, curr + 3);
                data.push(10);
                doagarcommand.writeUint32(data, curr);
			...
			'sendGplusToken': function (ogarsettings) {
				this['sendAccessToken'](ogarsettings, 4);
			},
			...
			'setClientVersion': function (ogarsettings, more2ogarset) {
				this[`clientVersion`] = ogarsettings, this[`clientVersionString`] = more2ogarset;
				// console[`log`]('[Agarbot.OVH] Client version:', ogarsettings, more2ogarset);
			},
			'generateClientKey': function (ogarsettings, more2ogarset) {
				...
				return more1ogarset != ogarparsedchars && (more1ogarset = 0 | Math[`imul`](ogarbuffed[ogario1Commands] ^ ogarparsedchars, moreogarset)), more1ogarset ^= ogarparsedchars = more1ogarset >>> 13, more1ogarset = 0 | Math[`imul`](more1ogarset, moreogarset), more1ogarset ^= ogarparsedchars = more1ogarset >>> 15, more1ogarset;
				// console[`log`]('[Agarbot.OVH] Generated client key:', more1ogarset);
			},
			...
			'handleMessage': function (ogarsettings) {
				...
				switch (54 == more3ogarset && (more3ogarset = 53), more3ogarset) {
					...
					case 18:
						...
						break;
					case 32:
						this.playerCellIDs.push(ogarsettings.getUint32(moreogarset, !0))
						if (!this.play) {
							this.play = !0;
					...
					case 53:
						...
						// console.log('real :'+D[0].name+' first: '+decodeURIComponent(escape(unescape(encodeURIComponent("Tenบ🅾usSթosτe꧂")).slice(0, 15))));
						if (this[`leaderboard`][0].nick == window.clientname)
						{
							// console.log('%c [DEBUG] I AM LEADER', 'background: #222; color: #bada55');
							window.iamleader = true;
						}
						else
						{
					...
					case 69:
						...
						for (ogarbuffed = 0; ogarbuffed < ogarparsedchars; ogarbuffed++) {
							...
							if (moremenusets > max) {
								...
								g2g = [{
											...
											'x': ogarparsedemoticons + this.mapOffsetX,
											'y': ogarsets1 + this.mapOffsetY,
						...
						break;
					case 85:
						console[`log`](`[Agarbot.OVH] Captcha requested`), more2ogarset[`master`] && more2ogarset[`master`][`recaptchaRequested`] && more2ogarset[`master`][`recaptchaRequested`]();
						break;
					case 102:
					...
					case 226:
						break;
					case 241:
						this['protocolKey'] = ogarsettings[`getUint32`](moreogarset, !0);// console[`log`](`[Agarbot.OVH] Received protocol key:`, this[`protocolKey`]);
					...
					case 255:
						...
						break;
					default:
						console['log']('[Agarbot.OVH] Unknown opcode:', ogarsettings[`getUint8`](0));
				}
			},
			'handleSubmessage': function (ogarsettings) {
				...
				switch ((ogarsettings = this['decompressMessage'](ogarsettings))['readUInt8'](more2ogarset++)) {
					...
					case 64:
						...
						break;
					default:
						console[`log`]('[Agarbot.OVH] Unknown sub opcode:', ogarsettings[`readUInt8`](0));
				}
			},
		...
		var ogarfooddrawer = {
			...
			ogario11Hotkeys = {
				...
				//GOlman
				'hk-botfeed': {
					'label': ogarcomms[`hk-botfeed`],
					'defaultKey': 'C',
					'keyDown': function () {
						ogarminimapdrawer && ogarminimapdrawer[`botfeed`](!0);
					},
					'keyUp': function () {
						ogarminimapdrawer && ogarminimapdrawer[`botfeed`](!1);
					},
					'type': 'normal'
				},
				'hk-botsplit': {
					
					'label': ogarcomms[`hk-botsplit`],
					'defaultKey': 'X',
					'keyDown': function () {
						ogarminimapdrawer && ogarminimapdrawer[`botsplit`]();
					},
					'keyUp': null,
					/*'keyUp': function () {
						ogarminimapdrawer && ogarminimapdrawer[`botsplit`](!1);
					},*/
					'type': 'normal'
					...
					'defaultKey': 'X',
					'keyDown': function () {
						ogarminimapdrawer && ogarminimapdrawer[`botsplit`](!0);
					},
					'keyUp': function () {
						ogarminimapdrawer && ogarminimapdrawer[`botsplit`](!1);
					},
				...
				'hk-botsplitX2': {
					'label': ogarcomms[`hk-botsplitX2`],
					'defaultKey': 'E',
					'keyDown': function () {
						ogarminimapdrawer && ogarminimapdrawer[`botsplitX2`](!0);
					},
					'keyUp': null,
					// 'keyUp': function () {
						// ogarminimapdrawer && ogarminimapdrawer[`botsplitX2`](!1);
					// },
					'type': 'normal'
				},
				'hk-botsplitX4': {
					'label': ogarcomms[`hk-botsplitX4`],
					'defaultKey': 'T',
					'keyDown': function () {
						ogarminimapdrawer && ogarminimapdrawer[`botsplitX4`](!0);
					},
					'keyUp': null,
					// 'keyUp': function () {
						// ogarminimapdrawer && ogarminimapdrawer[`botsplitX4`](!1);
					// },
					'type': 'normal'
				},				
				//End
				...
				'hk-dstbot': {
					'label': ogarcomms[`hk-dstbot`],
					'defaultKey': 'K',
					'keyDown': function () {
						ogarminimapdrawer && ogarminimapdrawer['setDstBot']();
					},
					'keyUp': null,
					'type': `normal`
				},
				'hk-botvshield': {
					'label': ogarcomms[`hk-botvshield`],
					'defaultKey': 'V',
					'keyDown': function () {
						ogarminimapdrawer && ogarminimapdrawer['setbotvshield']();
					},
					'keyUp': null,
					'type': `normal`
				},
				'hk-botsmode': {
					'label': ogarcomms[`hk-botsmode`],
					'defaultKey': 'J',
					'keyDown': function () {
						ogarminimapdrawer && ogarminimapdrawer['setbotsmode']();
					},
					'keyUp': null,
					'type': `normal`
				},				
